            ...
            <ul class="navbar-nav ml-lg-auto">
                    ...
                    <div class="dropdown-menu navbar-dropdown mail-notification dropdownAnimation" aria-labelledby="MailDropdown">
                        <a class="dropdown-item" href="#">
                            <div class="sender-img">
                                <img src="/admin/images/faces/face6.jpg" alt="">
                        ...
                        <a class="dropdown-item" href="#">
                            <div class="sender-img">
                                <img src="/admin/images/faces/face2.jpg" alt="">
                                <span class="badge badge-success">&nbsp;</span>
                            </div>
                            <div class="sender">
                        ...
                        <a class="dropdown-item" href="#">
                            <div class="sender-img">
                                <img src="/admin/images/faces/face3.jpg" alt="">
                        ...
                        <a class="dropdown-item" href="#">
                            <div class="sender-img">
                                <img src="/admin/images/faces/face4.jpg" alt="">
                ...
                <li class="nav-item d-none d-sm-block profile-img">
                    <a class="nav-link profile-image" href="#">
                        <img src="/admin/images/faces/face4.jpg" alt="profile-img">
        ...
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <div class="content-wrapper">
                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" style="width: 50%;">
                                                <input type="text" name="duration" class="form-control" aria-label="Amount (to the nearest dollar)">
                    ...
                    <div class="col-md-6 grid-margin stretch-card card table-sorter-wrapper table-responsive table-hover">
                        <table  id="sortable-table-2" class="table table-striped" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th class="sortStyle">Actions<i class="mdi mdi-chevron-down"></i></th>
                                <th class="sortStyle">Actions<i class="mdi mdi-chevron-down"></i></th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr id="${course.id}">
                                ...
                                <td>
                                    <button class="btn btn-outline-primary" id="${course.courseName?replace(" ","")}" onclick="archiveCourse('${course.id}', this.id);">
                                        <#if course.active>archive<#else >restore</#if>
                                    </button>
                                </td>
                                <#--todo add getMapping for delete request -->
                                <td>
                                    <button class="btn btn-outline-primary" onclick="deleteCourse('${course.id}')">delete</button>
                                </td>
                            </tr>
                            <#else >
                            </#list>
