                ...
                <div class="project-list">
                    ...
                    <div class="project">
                        <div class="project-content">
                            <figure class="project-image" style="min-height: 18rem;"><img src="${course.courseImageUrl!'images/defaultCoursePic.jpg'}" style="max-height: 17rem; " alt="Project"></figure>
                            <h3 class="project-title">${course.courseName}</h3>
                            <p style="text-align: left; margin-left: 5%;" >${course.startDate}</p>
