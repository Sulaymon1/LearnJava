...
<table class="table"
    ...
    <tr>
        ...
        <td>name, order</td>
        <td>
        Fires when student sort a column, the parameters contains: <br>
    ...
    <tr>
        ...
        <td>row</td>
        <td>
        Fires when student check a row, the parameters contains: <br>
    ...
    <tr>
        ...
        <td>row</td>
        <td>
        Fires when student uncheck a row, the parameters contains: <br>
        row: the record corresponding to the clicked row.
    ...
    <tr>
        ...
        <td>rows</td>
        <td>
        Fires when student check all rows, the parameters contains: <br>
    ...
    <tr>
        ...
        <td>rows</td>
        <td>
        Fires when student uncheck all rows, the parameters contains: <br>
    ...
    <tr>
        ...
        <td>rows</td>
        <td>
        Fires when student check some rows, the parameters contains: <br>
        rows: array of records corresponding to previously checked rows.
        </td>
    </tr>
    <tr>
        ...
        <td>rows</td>
        <td>
        Fires when student uncheck some rows, the parameters contains: <br>
        rows: array of records corresponding to previously checked rows.
        </td>
    </tr>
    <tr>
